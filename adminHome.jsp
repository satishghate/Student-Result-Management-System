...
<body>
<img src="images/golu.jpg"  align="left"width="100" height="100">
<center><img src="images/dgi.jpg" width="100" height="100">
<img src="images/satish.jpg" align="right"  width="100" height="100"></center>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">C Language</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">C++ Language</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">Core Java Language</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">Adv Java Language</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Oracle Language</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">HTML & CSS Language</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Java Script Language</label>
                                    <div class="col-md-6">
...
<section>
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          ...
          <th>C Language</th>
          <th>C++ Language</th>
          <th>Core Java Language</th>
          <th>Adv Java Language</th>
          <th>Oracle Language</th>
          <th>HTML & CSS Language</th>
          <th>Java Script Language</th>
        </tr>
      </thead>
    </table>
  </div>
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact Satish Ghate.
Designed & Developed by Satish Ghate</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ Satish :: 2023</h5></center> 
  <hr class="new1">
<br>
</body>
</html>